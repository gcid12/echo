...
import dataSet from '../../data/data001.json';
...
class Layout extends Component {
  ...
  render() {
    ...
    const one = this.state.filter_one;
    const two = this.state.filter_two;
    const three = this.state.filter_three;
          ...
          <div className="layout_wrapper">
            ...
            <div className="content_wrapper">
              ...
              <div className={ClassNames('filter_wrapper', { hidden: !filters })}>
                ...
                <br/><br/>
                <Filter>
                  <div><Checkbox name="uno" toggle defaultChecked label='UNO' onClick={() => this.setState({filter_one : !one })} /></div>
                  <div><Checkbox name="dos" toggle defaultChecked label='DOS' onClick={() => this.setState({filter_two : !two })} /></div>
                  <div><Checkbox name="tres" toggle defaultChecked label='TRES' onClick={() => this.setState({filter_three : !three })} /></div>
                  <hr/>
